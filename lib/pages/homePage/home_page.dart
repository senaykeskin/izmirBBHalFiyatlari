...
class _HomePageState extends State<HomePage> {
  ...
  Container listBoxContainer<T>({
    ...
    if (item is FishesModels) {
      ...
      fruits = item.halFiyatListesi
          ?.where((element) => element.malTipAdi == GeneralStrings.fruit)
          .toList();
      vegetables = item.halFiyatListesi
          ?.where((element) => element.malTipAdi == GeneralStrings.vegetable)
          .toList();
